...
const Polygon northAmericaPoly{{
...
const Polygon southAmericaPoly{{
...
const LatLng saintPpos(59.94324044769604,30.304845135274263);

// ==========================

const LatLng pointTest = LatLng{
    -62.7798,-154.177
};

const LineString lineTest = LineString{
    {-48.3894, -112.405},
    {-69.76, -113.924},
    {-57.4991, -64.557},
};

const Polygon polyTest = Polygon{
    LineString({
        {-53.638, 12.1519},
        {-64.4664, 5.31646},
        {-64.1371, 30.3797},
...
const MultiPolygon multiPolyTest = MultiPolygon{
    Polygon(
        LineString({
            {-52.5269, 80.5571},
            {-64.6115, 80.5571},
